!(function (t) {
    ...
    Z.render = (t, e, n) => {
      ...
      if (
        (((t, e, n) => {
          ...
          void 0 === i &&
            (s(e, e.firstChild),
            N.set(e, (i = new _(Object.assign({ templateFactory: C }, n)))),
            i.appendInto(e)),
            i.setValue(t),
            i.commit();
        })(t, l, Object.assign({ templateFactory: L(i) }, n)),
        a)
      ) {
        const t = N.get(l);
        N.delete(l),
        ...
        (t.exports = function (t, e, n, l) {
          ...
          y
            ? ((f = n(function (t, n, i, o) {
                ...
                for (
                  d(t, "_d", { b: r, o: p, l: s, e: a, v: new Y(r) });
                  h < a;
    ...
    !(function (n) {
      ...
      (o.prototype.enable = function (t, e) {
        return this.enabled
          ? void 0
          : this.supported
          ? void navigator.requestMIDIAccess({ sysex: e }).then(
              function (e) {
                function n() {
                  clearTimeout(i),
        ...
        (r.prototype._parseChannelEvent = function (t) {
          ...
          (i === a.MIDI_CHANNEL_MESSAGES.noteon && 0 === n)
            ...
            ? ((r.type = "controlchange"),
              (r.controller = { number: e, name: this.getCcNameByNumber(e) }),
              (r.value = n))
        ...
        (s.prototype._selectRegisteredParameter = function (t, e, n) {
          ...
          return (
            a.toMIDIChannels(e).forEach(function (o) {
              i.sendControlChange(101, t[0], e, { time: n }),
                i.sendControlChange(100, t[1], e, { time: n });
            }),
            this
          );
        }),
        (s.prototype._selectNonRegisteredParameter = function (t, e, n) {
          ...
          return (
            a.toMIDIChannels(e).forEach(function (o) {
              i.sendControlChange(99, t[0], e, { time: n }),
                i.sendControlChange(98, t[1], e, { time: n });
            }),
            this
          );
        }),
        (s.prototype._setCurrentRegisteredParameter = function (t, e, n) {
          ...
          return (
            a.toMIDIChannels(e).forEach(function (o) {
              i.sendControlChange(6, t[0], e, { time: n });
            }),
            (t[1] = Math.floor(t[1])),
            t[1] >= 0 &&
              t[1] <= 127 &&
              a.toMIDIChannels(e).forEach(function (o) {
                i.sendControlChange(38, t[1], e, { time: n });
              }),
            this
          );
        }),
        (s.prototype._deselectRegisteredParameter = function (t, e) {
          ...
          return (
            a.toMIDIChannels(t).forEach(function (i) {
              n.sendControlChange(101, 127, t, { time: e }),
                n.sendControlChange(100, 127, t, { time: e });
            }),
            this
          );
        }),
          ...
          return (
            a.toMIDIChannels(e).forEach(function (o) {
              i._selectRegisteredParameter(t, e, n.time),
                i.sendControlChange(96, 0, e, { time: n.time }),
            ...
            a.toMIDIChannels(e).forEach(
              function (i) {
                this._selectRegisteredParameter(t, e, n.time),
                  this.sendControlChange(97, 0, e, { time: n.time }),
        ...
        (s.prototype.setTuningProgram = function (t, e, n) {
          ...
          return (
            a.toMIDIChannels(e).forEach(function (o) {
              i.setRegisteredParameter("tuningprogram", t, e, { time: n.time });
            }),
            this
          );
        }),
        (s.prototype.setTuningBank = function (t, e, n) {
          ...
          return (
            a.toMIDIChannels(e).forEach(function (o) {
              i.setRegisteredParameter("tuningbank", t, e, { time: n.time });
            }),
            this
          );
        }),
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, f, v, b, m) {
      ...
      if (
        (C &&
          (x = u(C.call(new t()))) !== Object.prototype &&
          x.next &&
  ...
  function (t, e, n) {
    ...
    t.exports = function () {
      ...
      if (l)
        ...
        new r(c).observe(d, { characterData: !0 }),
          (n = function () {
            d.data = h = !h;
          });
      }
  ...
  function (t, e, n) {
    n(9) &&
      "g" != /./g.flags &&
      n(8).f(RegExp.prototype, "flags", { configurable: !0, get: n(62) });
  },
  function (t, e) {
    t.exports = function (t) {
      try {
  ...
  function (t, e, n) {
    ...
    !(function (o) {
      ...
      function k(t) {
        ...
        return [
          d(t),
          d({ h: (n + 120) % 360, s: e.s, l: e.l }),
          d({ h: (n + 240) % 360, s: e.s, l: e.l }),
        ];
      }
      function M(t) {
        var e = d(t).toHsl(),
        ...
        return [
          d(t),
          d({ h: (n + 90) % 360, s: e.s, l: e.l }),
          d({ h: (n + 180) % 360, s: e.s, l: e.l }),
          d({ h: (n + 270) % 360, s: e.s, l: e.l }),
        ];
      }
      function A(t) {
        var e = d(t).toHsl(),
        ...
        return [
          d(t),
          d({ h: (n + 72) % 360, s: e.s, l: e.l }),
          d({ h: (n + 216) % 360, s: e.s, l: e.l }),
        ];
      }
      function I(t, e, n) {
        (e = e || 6), (n = n || 30);
      ...
      (d.prototype = {
        ...
        setAlpha: function (t) {
          return (
            (this._a = P(t)), (this._roundA = l(100 * this._a) / 100), this
          );
        },
        toHsv: function () {
        ...
        (d.mostReadable = function (t, e, n) {
          ...
          return d.isReadable(t, a, { level: r, size: s }) || !o
            ? a
    ...
    n(9) &&
      i(i.P + n(68), "Object", {
        __defineGetter__: function (t, e) {
          s.f(o(this), t, { get: r(e), enumerable: !0, configurable: !0 });
        },
      });
  },
  function (t, e, n) {
    ...
    n(9) &&
      i(i.P + n(68), "Object", {
        __defineSetter__: function (t, e) {
          s.f(o(this), t, { set: r(e), enumerable: !0, configurable: !0 });
        },
      });
  },
  function (t, e, n) {
...
*/
      ...
      static getFlattenedNodes(t) {
        return g(t)
          ...
          : Array.from(t.childNodes)
              .map((t) => (g(t) ? (t = t).assignedNodes({ flatten: !0 }) : [t]))
    ...
    class _ extends i.a {
      static get properties() {
        return { selectedIndex: { type: Number }, attribute: { type: String } };
      }
      constructor() {
        super(),
    ...
    customElements.define(
      ...
      class extends _ {
        static get properties() {
          return { label: { type: String }, attribute: { type: String } };
        }
        constructor() {
          super(), (this.label = "");
        }
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { playing: { type: Boolean }, disabled: { type: Boolean } };
        }
        constructor() {
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { color: { type: String }, loading: { type: Boolean } };
        }
        constructor() {
        ...
        visualize(t) {
          if (((this.loading = !t.loaded), t.loaded)) {
            ...
            const l = C()(this.color).setAlpha(0.2).toRgbString();
    ...
    customElements.define(
      ...
      class extends o.a {
        static get properties() {
          return { label: { type: String }, duration: { type: Number } };
        }
        constructor() {
      ...
      class extends i.a {
        ...
        _logValue(t) {
          ...
          this.integer && (o = Math.round(o)),
            (this.value = o),
            this.dispatchEvent(
              new CustomEvent("input", { composed: !0, detail: this.value })
            );
        }
        _exp(t, e) {
      ...
      class extends i.a {
        ...
        mousedown(t) {
          if (t.buttons) {
            ...
            this.requestUpdate(),
              this.dispatchEvent(
                new CustomEvent("change", { detail: this.value, composed: !0 })
              ),
              this.attribute &&
                this.dispatchEvent(
                  new CustomEvent(this.attribute, {
      ...
      class extends i.a {
        ...
        constructor() {
          super(),
            ...
            (this.octaves = 4),
            (this.polyphonic = !1),
            (this._computerKeyboard = new $.a({ polyphony: 1 / 0 })),
            ...
            this._flash(),
              this.dispatchEvent(
                new CustomEvent("noteon", {
                  detail: { name: e, midi: n, velocity: t.velocity },
                  composed: !0,
                  bubbles: !0,
                })
              );
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { polyphonic: { type: Boolean } };
        }
        constructor() {
          super();
        }
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { label: { type: String }, disabled: { type: Boolean } };
        }
        constructor() {
          super();
        }
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { triggered: { type: Boolean }, disabled: { type: Boolean } };
        }
        constructor() {
      ...
      class extends i.a {
        ...
        updated(t) {
          if (t.has("position")) {
            ...
            this.dispatchEvent(
              new CustomEvent("position", { detail: t, composed: !0 })
            );
          }
        }
        loop(t) {
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        _getXY(t) {
          ...
          return { x: Math.clamp(i / e, 0, 1), y: 1 - Math.clamp(o / n, 0, 1) };
        }
        _mousedown(t) {
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { label: { type: String }, presets: { type: String } };
        }
        constructor() {
          super(),
            (this.label = "Presets"),
        ...
        _clicked(t, e) {
          ...
          this.dispatchEvent(
            new CustomEvent("preset", { detail: n, composed: !0, bubbles: !0 })
          );
        }
        render() {
    ...
    customElements.define(
      ...
      class extends D.a {
        ...
        async visualize(t) {
          (this.buffer = t.getFrequencyResponse().map((t) => Math.pow(t, 0.5))),
            this.requestUpdate();
        }
      }
    );
    customElements.define(
      ...
      class extends o.a {
        static get properties() {
          return { label: { type: String }, frequency: { type: Boolean } };
        }
        constructor() {
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { value: { type: Number }, attribute: { type: String } };
        }
        constructor() {
          super(), (this.value = 0);
        }
    ...
    customElements.define(
      ...
      class extends o.a {
        static get properties() {
          return { controls: { type: Boolean }, position: { type: Boolean } };
        }
        constructor() {
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { collapsed: { type: Boolean }, label: { type: String } };
        }
        constructor() {
          super(),
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { loaded: { type: Boolean }, progress: { type: Number } };
        }
        constructor() {
          super(),
            (this.progress = 0),
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { collapsed: { type: Boolean }, open: { type: Boolean } };
        }
        constructor() {
          super(), (this.collapsed = !0);
        }
    ...
    customElements.define(
      ...
      class extends i.a {
        static get properties() {
          return { running: { type: Boolean }, disabled: { type: Boolean } };
        }
        constructor() {
    ...
    customElements.define(
      ...
      class extends nt {
        static get properties() {
          return { generating: { type: Boolean } };
        }
        constructor() {
